...
import javax.swing.JOptionPane;
 /*Indicar cuantos productos cuestan más de 10.000 y cuantos productos cuentan con una cantidad imferior o igual a 4 unidades*/

public class Productos {

    public static void main(String[] args) {
        
        producto VP[] = new producto [2];
        producto P; 
        int sumaProductos=0;
        int contadorUidades=0;
        ...
        System.out.println("Los productos que cuentan con una cantidad inferior o igual a 4 unidades es: "+ contadorUidades );
